    ...
    <>
      <WrapperBanner>
       ...
       <span className="absolute top-2.5 left-2.5  px-2 py-1 text-sm rounded-[3px] bg-yellow-600 text-white font-semibold">
                ...
                <div className="bg-[#B8E1D9] rounded-[10px] h-27.75 flex items-center justify-center mb-2">
               <FaVideo className="text-primary w-15 h-15" />
                ...
                <p className="text-gray-500 text-xs">Expires: 10:00 AM 10/10/2026</p>
      ...
      <ResourceVideoPlayer  isOpen={selectedSession}  onClose={()=>setSelectedSession("")} />
    </>
  );
}
