      ...
      <WrapperBanner>
        <div className="relative">
          <button
            ...
            className="px-2 py-2 rounded-full bg-gradient-to-r from-teal-400 to-teal-700 text-white font-semibold shadow-lg hover:scale-105 transition absolute top-10 left-10 text-2xl font-bold"
          >
            <IoMdArrowRoundBack />
          </button>
            ...
            <div className="md:px-12.5 px-5 md:pb-12.5 pb-5 rounded-xl ">
              ...
              <div className="flex justify-between flex-wrap  mb-5">
                ...
                <button
                  ...
                  className="px-4 py-2 cursor-pointer rounded-full bg-[linear-gradient(90deg,var(--color-AquaBlue)_0%,var(--color-primary)_100%)] text-white font-semibold shadow-lg hover:scale-105 transition"
                >
                  Add New Insurance
                </button>
              </div>
