...
export default function ResourcesVideos() {
  ...
  const [selectedSessionFree, setSelectedSessionFree] = useState<ResourcesType | undefined>(undefined);
  const [selectedSessionPaid, setSelectedSessionPaid] = useState<ResourcesType | undefined>(undefined);
