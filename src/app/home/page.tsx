    ...
    <main>
      ...
      <section className="w-full bg-[linear-gradient(62deg,var(--color-primary)_40%,var(--color-MintGreen)_100%)] md:py-[150px] py-[100px]">
        <div className="max-w-[900px] px-[20px] mx-auto text-center mb-[60px] ">
          ...
          <p className="lg:text-2xl text-lg font-medium text-white lg:leading-[36px] leading-[30px]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
        </div>
      ...
      >
        <div className="max-w-[1300px] w-full px-[20px] mx-auto">
          <div className="max-w-[900px] md:px-[20px] px-0 mx-auto text-center md:mb-[100px] mb-[60px] ">
            ...
            <p className="lg:text-2xl text-lg font-medium text-primary leading-[36px]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
          </div>
